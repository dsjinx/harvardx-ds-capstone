...
knitr::kable(edx[9,])
```
We use the beginning example to remind ourselves that, the 'genres' information of each movie are given, so heuristically we can make the assumption that each user also has some preference toward some particular genres. 
