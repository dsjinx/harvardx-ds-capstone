...
$$
Loss_{en} = \frac{1}{2N}\sum_{m \in N}\|y_{ui} - \beta_{u0} - \vec{x}_m^{T}\vec{\beta}_u\|_F^2 + \lambda\Big[(1 - \alpha)\frac{\|\beta\|_F^2}{2} + \alpha \sum_{j \in 19}\|\beta_j\|_2\Big]
$$
...
From the understanding of its regularisation structure, 
