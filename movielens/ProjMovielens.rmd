...
The next code chunk will give us a residual table with each non NA element is filled by $\bar{r_{g}} + b_u + b_m - r_{ui}$. We get the NA's in reset, because we are making a "movieId"x"userI" big table. 
```{r eval = FALSE}
