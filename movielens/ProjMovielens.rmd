...
```
\textcolor{red}{*} "g_mean + u_bias + m_bias + gen_bias + latent_factor" is for demonstration only, the real code in calculation is "g_mean + u_bias + m_bias - gen_bias - latent_factor", refer the code chunk in above for explanations.  
